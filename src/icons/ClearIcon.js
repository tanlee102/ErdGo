/** Presentational SVG for clearing editor content. */
export default function ClearIcon({ className = '', width = '24px', height = '24px' }) {
    return (
        <svg viewBox="0 0 1024 1024" width={width} height={height} className={className}>
