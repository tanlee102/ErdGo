/** Presentational SVG for automatic ERD color assignment. */
export default function AutoColorOnlyIcon({ className = '', width = '26px', height = '26px' }) {
    return (
        <svg viewBox="0 0 512 512" width={width} height={height} className={className} fill="none" aria-hidden="true">
            <path
